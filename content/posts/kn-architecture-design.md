...
> - **下篇**：[KN 改造方案：从源码出发](/posts/kn-transformation-from-nashsu/) —— 具体怎么改，最终产品形态
...
nashsu/llm_wiki 在诉求 2/3/4/5 上已经有高质量的核心实现（详见[上篇源码分析](/posts/nashsu-llmwiki-architecture-deep-dive/)）。KN 的任务是在此基础上补全诉求 1（多入口上传）、诉求 6（MCP + WebUI 双通道）、诉求 7（企业级治理），以及将桌面单用户架构改造为多租户服务端。
...
调研结论详见[企业级 LLM Wiki 方案调研报告](/posts/llm-wiki-enterprise-research/)和[上篇源码分析](/posts/nashsu-llmwiki-architecture-deep-dive/)。选型核心依据：
...
> - **下篇**：[KN 改造方案：从源码出发](/posts/kn-transformation-from-nashsu/) —— 具体改法与最终产品形态
